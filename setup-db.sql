-- Sutra Sprint / VedAnk Academy — complete schema
-- Generated from the live database, dependency-ordered and idempotent.
-- Run once against a FRESH Neon database:
--   psql "$DATABASE_URL" -f setup-db.sql
-- Safe to re-run: every statement is IF NOT EXISTS.

-- gen_random_uuid() comes from pgcrypto; Neon has it, this is belt and braces
